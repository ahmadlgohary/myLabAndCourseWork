...
DISPATCHER      CMPA  #START                    ; If it’s the START state ------------------+
                ...
                BRA   DISP_EXIT                 ; and exit                                  I
                                                ;                                           S
NOT_START       CMPA  #FWD                      ; compare A with state of machine           P
                BNE   NOT_FORWARD               ; branch if not equal 0                     A
                JSR   FWD_ST                    ; jump to subroutine                        T
                JMP   DISP_EXIT                 ; exit                                      C
                                                ;                                           H
NOT_FORWARD     CMPA  #REV                      ;                                           E
                BNE   NOT_REVERSE               ;                                           R
                JSR   REV_ST                    ;                                           |
                JMP   DISP_EXIT                 ;                                           |
                                                ;                                           |
...
;********************************************************************************************
START_ST        BRCLR PORTAD0,$04,NO_FWD        ; If FWD_BUMP clear
                JSR   INIT_FWD                  ; Initialize the FORWARD state
                MOVB  #FWD,CRNT_STATE           ; Go to FORWARD state
                BRA   START_EXIT
...
;********************************************************************************************
FWD_ST          BRSET PORTAD0,$04,NO_FWD_BUMP   ; If FWD_BUMP set
                JSR   INIT_REV                  ; initialize the REVERSE routine
                MOVB  #REV,CRNT_STATE           ; set the state to REVERSE
                JMP   FWD_EXIT                  ; return

NO_FWD_BUMP     BRSET PORTAD0,$08,NO_REAR_BUMP  ; If REAR_BUMP, then stop
...
;********************************************************************************************
initLCD         BSET  DDRB,%11111111            ; configure pins B  output
                BSET  DDRJ,%11000000            ; configure pins J (7 and 6) for output
